  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the Resume
        Builder parser algorithm and walks through the 4 steps on how it works.
        (Note that the algorithm is designed to parse single column resume in
        English language)
      </Paragraph>
      ...
      <Paragraph>
        And that is everything about the Resume Builder parser algorithm :)
      </Paragraph>
      <Paragraph>
