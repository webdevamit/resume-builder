...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          copying and pasting. On the other hand, a resume builder like Resume
          Builder saves time and prevents formatting mistakes by automatically
  ...
  {
    question:
      "Q2. What uniquely sets Resume Builder apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than Resume Builder, there are some great free resume builders
          out there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>
          , <Link href="https://flowcv.com/">FlowCV</Link>. However, Resume
          Builder stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. Resume Builder is designed specifically for the U.S. job market
            and best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, Resume Builder intentionally only offers
          ...
          like references. Additionally, Resume Builder only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. Resume Builder is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, Resume Builder believes that resume data
          should remain private and accessible only on user’s local machine.
          Therefore, Resume Builder doesn’t require sign up to use the app, and
          all inputted data is stored in user’s browser that only user has
          access to.
        </p>
      </>
    ),
  ...
  {
    question: "Q3. Who created Resume Builder and why?",
    answer: (
      <p>
        Resume Builder was created by{" "}
        ...
        that led to Resume Builder, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that Resume Builder can
        help anyone to easily create a modern professional resume that follows
        best practices and enable anyone to apply for jobs with confidence.
      </p>
    ),
  },
  {
    question: "Q4. How can I support Resume Builder?",
    answer: (
      <>
        <p>
          The best way to support Resume Builder is to share your thoughts and
        ...
        <p>
          Another great way to support Resume Builder is by spreading the words.
